                          ...
                          onPressed: () {
                            context.read<InvoiceCubit>().createInvoice(
                                Invoice(
                                    ...
                                    receiverName: receiveController.text,
        ...
        body: BlocListener<InvoiceCubit, InvoiceState>(
          ...
          if (state is InvoiceUpdateerror) {
            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                content: Text('Sorry, some update error occur')));
          }
          if (state is InvoiceDeeltingerror) {
            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                content: Text('Sorry, some deleting error occur')));
          }
          if (state is InvoiceDeleted) {
            ScaffoldMessenger.of(context)
                .showSnackBar(const SnackBar(content: Text('Deleted')));
          }
        }, child: BlocBuilder<FetchcontrollerCubit, FetchcontrollerState>(
                      ...
                      children: [
                        Expanded(
                            child: Lottie.network(
                                'https://assets3.lottiefiles.com/packages/lf20_qlwqp9xi.json')),
                        Expanded(
                            child: Lottie.network(
                                'https://assets7.lottiefiles.com/packages/lf20_fFVfCt.json'))
                      ],
                    )
                  : Container(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      InkWell(
                                        onTap: () {
                                          invoiceNumberController.text = state
